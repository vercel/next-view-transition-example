...
export default function Page() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-24 sm:px-8">
        {/* Header */}
        <div className="mb-16">
        ...
        <div className="space-y-1 mb-24">
          <Link 
            href="/blog" 
            className="group block rounded-lg p-6 transition-colors"
          >
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl font-semibold mb-2 text-black group-hover:text-gray-400 transition-colors">
                  Floating Elements
                </h2>
                <p className="text-gray-600 text-base leading-relaxed group-hover:text-gray-400 transition-colors">
                  Watch elements smoothly float and transition between different positions on the page
                </p>
              </div>
              <svg 
                className="w-5 h-5 flex-shrink-0 text-black group-hover:text-gray-400 group-hover:translate-x-1 transition-all" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
                strokeWidth={2}
        ...
        <div className="pt-8 border-t border-gray-200">
          <a 
            ...
            className="inline-flex items-center gap-2 text-sm text-black hover:text-gray-400 transition-colors"
          >
